...
namespace WorkFlowPresentation.Configuration
{
    public partial class RoleManagement : System.Web.UI.Page
    {
        ...
        {
            if (Session["EMPLID"] == null || (Session["EMPLID"].ToString() != "1234" && Session["EMPLID"].ToString() != "454017" && Session["EMPLID"].ToString() != "380616"))
            {
        ...
        private void FillGridView()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error("EmplID:" + Session["EMPLID"].ToString() + "---" + ex.Message + " --- Sql:  " + sqlQuery);
                throw ex;
            }
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Error("EmplID:" + Session["EMPLID"].ToString() + "---" + ex.Message);
                throw ex;
            }
